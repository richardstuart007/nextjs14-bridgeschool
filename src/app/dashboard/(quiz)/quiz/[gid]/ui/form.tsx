...
import { table_Questions, table_Usershistory_New } from '@/src/lib/definitions'
import QuizQuestion from '@/src/app/dashboard/(quiz)/quiz-question/quiz-question'
import QuizBidding from '@/src/app/dashboard/(quiz)/quiz-question/quiz-bidding/QuizBidding'
import QuizHands from '@/src/app/dashboard/(quiz)/quiz-question/quiz-hands/QuizHands'
import QuizChoice from './quiz-choice'
import { QuizSubmit } from '@/src/app/dashboard/(quiz)/quiz/[gid]/ui/buttons'
import { useRouter } from 'next/navigation'
import { writeUsershistory } from '@/src/lib/data/tables/usershistory'
